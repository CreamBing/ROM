...
public class HttpAsyncClientUtils {
    ...
    private static Logger LOG = LoggerFactory.getLogger(HttpAsyncClientUtils.class);

    public static void exeAsyncReq(String baseUrl, boolean isPost,
        ...
        try {
            ...
            LOG.info("exeAsyncReq getparams:" + httpMethod.getURI());
